<template>
  <div class="button-gelatine-template" >
    <a class="btn">
      <slot />
    </a>
  </div>
...
a.btn {
  ...
  @include box-shadow(0 0 0  2px $color-bg, 0 0 0 4px darken($color-bg, 5%) );
  border: none;
  ...
  &:hover,
  &:focus {
    @include box-shadow(0 0 0 2px $color-bg, 0 0 0 4px darken($color-btn-active-border, 5%));
