<template>
    <div class="vue-lottery">
        <div class="lottery_bg">
            <!-- <img :src="lotterybg"> -->
            <div class="vue-lottery-panel">
                <div class="vue-lottery-panel-body">
        ...
        <div class="lottery_pointer" :style="{width:lotterywidth[1]}" @click="clickLottery">
            <!-- <img :src="pointerbg"> -->
            <div class="lottery_pointer_button">
                <vue-clap-button />
            </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    startRotate() {
      ...
      var oneAngel =
        self.angle +
        firstTimes * (firstTimes - 1) / 2 * acceleration +
        highSpeed; // 第一阶段的旋转度数
      ...
      var add =
        360 -
        (twoAngel + three * (three - 1) / 2 * racceleration) % 360 +
